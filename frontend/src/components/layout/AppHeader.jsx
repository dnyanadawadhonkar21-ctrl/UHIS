            ...
            {notificationsOpen && (
              ...
              >
                <div style={{ padding: "0.75rem 1rem", borderBottom: "1px solid var(--color-border)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <span className="type-heading" style={{ fontSize: "0.85rem" }}>Notifications</span>
                  <span className="status-warning" style={{ fontSize: "0.65rem" }}>3 New</span>
                </div>
                <div>
                  {notifications.map((n) => (
                    <div key={n.id} style={{ padding: "0.75rem 1rem", borderBottom: "1px solid var(--color-border)", display: "flex", flexDirection: "column", gap: "2px" }}>
                      <span className="type-value" style={{ fontSize: "0.8rem" }}>{n.title}</span>
