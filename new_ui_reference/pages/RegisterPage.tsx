...
export default function RegisterPage() {
  ...
  const ABHA_GENERATED = `91-${Math.floor(1000 + Math.random() * 9000)}-${Math.floor(1000 + Math.random() * 9000)}-${Math.floor(1000 + Math.random() * 9000)}`;
                  ...
                  <div className="instrument-panel">
                    ...
                    <div style={{ padding: "1.25rem" }}>
                      ...
                      <div className="type-micro">
                        ABHA Address: {form.name.toLowerCase().replace(" ", ".") || "your.name"}@abdm
                      </div>
                    </div>
                  </div>
