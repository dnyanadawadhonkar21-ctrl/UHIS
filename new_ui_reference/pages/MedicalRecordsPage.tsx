...
import { timeline, labReports, visits, conditions, medications } from "../data/mockData";
...
export default function MedicalRecordsPage() {
  ...
  const filteredTimeline = filter === "ALL"
    ? timeline
    : timeline.filter((t) => t.type === filter.toLowerCase());
      ...
      <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
        ...
        {activeTab === "timeline" && (
          <div className="fade-in">
            ...
            {/* Year grouping */}
            {["2024", "2023", "2022", "2021", "2020", "2019", "2018", "2012"].map((year) => {
